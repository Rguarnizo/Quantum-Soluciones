...
const AboutUs = () => {
  ...
  React.useEffect(() => {
    ...
    tl.fromTo(".image", { alpha: 0 }, { alpha: 1,stagger:0.4 }).fromTo(
      ".info",
      { alpha: 0 },
      { alpha: 1,  stagger:0.4 }
    );
  ...
  return (
    <section id="AboutUs" className=" md:px-16 px-5 dark:bg-gray-800">
      <div className="grid grid-cols-3 grid-rows-2 max-h-screen py-10 ">
        <div className="image flex py-8 md:py-16  justify-center h-2/3 md:h-full ">
          <Image
            width={"80%"}
            height={"100%"}
        ...
        <div className="image flex justify-items-center text-center justify-center col-span-2 md:col-span-1  h-2/3 md:h-full">
          <Image
            width={"65%"}
            height={"100%"}
            src="https://images.unsplash.com/photo-1559386484-97dfc0e15539?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1234&q=80"
        ...
        <div className="image md:flex justify-items-center text-center justify-center py-20 row-span-2 hidden">
          <Image
            width={"65%"}
            height={"100%"}
            src="https://images.unsplash.com/photo-1559386484-97dfc0e15539?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1234&q=80"
        ...
        <div className="flex col-span-3 md:col-span-2 justify-items-center justify- items-center">
          <div className="wrapper self-center">
            <Text className={titleClasses+" info"}>
              Acerca de nosotros <br /> <br />
            </Text>
            <Text className={descriptionClasses+" info"}>
