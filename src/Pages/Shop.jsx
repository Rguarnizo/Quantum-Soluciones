...
const Shop = () => {
  ...
  return (
    <section
      id="Shop"
      className="h-screen px-5 md:px-16 pt-10  dark:bg-gray-800"
    >
      <div className="grid xl:grid-cols-2 h-full">
        <div className="flex flex-col justify-center">
          <Text className="shop text-5xl font-bold tracking-tighter dark:text-blue-100">
          ...
          </Text>
          {
            ...
            <a
              // href="#"
              className="text text-lg text-blue-500 mt-5 font-semibold dark:text-white"
            >
